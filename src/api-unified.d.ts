...
declare interface ConnectionRequest extends ApiRequest {
    connection: ConnectionType;
}
declare interface ConnectionsRequest extends ApiRequest {
    connections: ConnectionListType;
}
declare interface CredentialsRequest extends ApiRequest {
    credentials: TableauCredentialsType;
}
declare interface DataAlertRequest extends ApiRequest {
    dataAlert: DataAlertType;
}
declare interface DataQualityWarningRequest extends ApiRequest {
    dataQualityWarning: DataQualityWarningType;
}
declare interface DataRoleRequest extends ApiRequest {
    dataRole: DataRoleType;
}
declare interface DatabaseRequest extends ApiRequest {
    database: DatabaseType;
}
declare interface DatabaseGroupRequest extends ApiRequest {
    databaseGroup: DatabaseGroupType;
}
declare interface DatasourceRequest extends ApiRequest {
    datasource: DataSourceType;
}
declare interface DistinctValuesRequest extends ApiRequest {
    distinctValues: DistinctValueListType;
}
declare interface FavoriteRequest extends ApiRequest {
    favorite: FavoriteType;
}
declare interface FavoriteOrderingsRequest extends ApiRequest {
    favoriteOrderings: FavoriteOrderingListType;
}
declare interface FieldRequest extends ApiRequest {
    field: FieldType;
}
declare interface FieldConceptRequest extends ApiRequest {
    fieldConcept: FieldConceptType;
}
declare interface FlowRequest extends ApiRequest {
    flow: FlowType;
}
declare interface FlowWarningsRequest extends ApiRequest {
    flowWarnings: FlowWarningsListContainerType;
}
declare interface GroupRequest extends ApiRequest {
    group: GroupType;
}
declare interface MetricRequest extends ApiRequest {
    metric: MetricType;
}
declare interface PermissionsRequest extends ApiRequest {
    permissions: PermissionsType;
}
declare interface ProjectRequest extends ApiRequest {
    project: ProjectType;
}
declare interface ScheduleRequest extends ApiRequest {
    schedule: ScheduleType;
}
declare interface SiteRequest extends ApiRequest {
    site: SiteType;
}
declare interface TableRequest extends ApiRequest {
    table: TableType;
}
declare interface TagsRequest extends ApiRequest {
    tags: TagListType;
}
declare interface UserRequest extends ApiRequest {
    user: UserType;
}
declare interface WebhookRequest extends ApiRequest {
    webhook: WebhookType;
}
declare interface WorkbookRequest extends ApiRequest {
    workbook: WorkbookType;
}
declare interface SubscriptionRequest extends ApiRequest {
    subscription: SubscriptionType;
}
declare interface TaskRequest extends ApiRequest {
    task: TaskType;
}
...
declare interface BackgroundJobResponse extends ApiResponse {
    backgroundJob: BackgroundJobType;
}
declare interface BackgroundJobsResponse extends ApiResponse {
    backgroundJobs: BackgroundJobListType;
}
declare interface ColumnResponse extends ApiResponse {
    column: ColumnType;
}
declare interface ConnectionResponse extends ApiResponse {
    connection: ConnectionType;
}
declare interface ConnectionsResponse extends ApiResponse {
    connections: ConnectionListType;
}
declare interface CredentialsResponse extends ApiResponse {
    credentials: TableauCredentialsType;
}
declare interface DataAlertResponse extends ApiResponse {
    dataAlert: DataAlertType;
}
declare interface DataAlertsResponse extends ApiResponse {
    dataAlerts: DataAlertListType;
}
declare interface DataQualityWarningResponse extends ApiResponse {
    dataQualityWarning: DataQualityWarningType;
}
declare interface DataQualityWarningListResponse extends ApiResponse {
    dataQualityWarningList: DataQualityWarningListType;
}
declare interface DataRoleResponse extends ApiResponse {
    dataRole: DataRoleType;
}
declare interface DatabaseResponse extends ApiResponse {
    database: DatabaseType;
}
declare interface DatasourceResponse extends ApiResponse {
    datasource: DataSourceType;
}
declare interface ErrorResponse extends ApiResponse {
    error: ErrorType;
}
declare interface FavoritesResponse extends ApiResponse {
    favorites: FavoriteListType;
}
declare interface FileUploadResponse extends ApiResponse {
    fileUpload: FileUploadType;
}
declare interface FlowResponse extends ApiResponse {
    flow: FlowType;
}
declare interface GroupResponse extends ApiResponse {
    group: GroupType;
}
declare interface JobResponse extends ApiResponse {
    job: JobType;
}
declare interface MetricResponse extends ApiResponse {
    metric: MetricType;
}
declare interface PermissionsResponse extends ApiResponse {
    permissions: PermissionsType;
}
declare interface ProjectResponse extends ApiResponse {
    project: ProjectType;
}
declare interface DataAlertsRecipientResponse extends ApiResponse {
    dataAlertsRecipient: DataAlertsRecipientType;
}
declare interface DataAlertsRecipientListResponse extends ApiResponse {
    dataAlertsRecipientList: DataAlertsRecipientListType;
}
declare interface ScheduleResponse extends ApiResponse {
    schedule: ScheduleType;
}
declare interface ServerInfoResponse extends ApiResponse {
    serverInfo: ServerInfo;
}
declare interface ServerSettingsResponse extends ApiResponse {
    serverSettings: ServerSettings;
}
declare interface SiteResponse extends ApiResponse {
    site: SiteType;
}
declare interface TableResponse extends ApiResponse {
    table: TableType;
}
declare interface TagsResponse extends ApiResponse {
    tags: TagListType;
}
declare interface UserResponse extends ApiResponse {
    user: UserType;
}
declare interface ViewResponse extends ApiResponse {
    view: ViewType;
}
declare interface ViewsResponse extends ApiResponse {
    views: ViewListType;
}
declare interface WebhookResponse extends ApiResponse {
    webhook: WebhookType;
}
declare interface WebhooksResponse extends ApiResponse {
    webhooks: WebhookListType;
}
declare interface WebhookTestResultResponse extends ApiResponse {
    webhookTestResult: WebhookTestResultType;
}
declare interface WorkbookResponse extends ApiResponse {
    workbook: WorkbookType;
}
declare interface SubscriptionResponse extends ApiResponse {
    subscription: SubscriptionType;
}
declare interface TaskResponse extends ApiResponse {
    task: TaskType;
}
declare interface TasksResponse extends ApiResponse {
    tasks: TaskListType;
}
declare interface WarningsResponse extends ApiResponse {
    warnings: WarningListType;
}
declare interface DegradationsResponse extends ApiResponse {
    degradations: DegradationListType;
}
declare interface ListFieldConceptsResponse extends ApiResponse {
    listFieldConcepts: ListFieldConceptsType;
}
declare interface FieldMatchesResponse extends ApiResponse {
    fieldMatches: FieldMatchListType;
}
declare interface ValueMatchesResponse extends ApiResponse {
    valueMatches: MatchValuesResultType;
}
declare interface ValueConceptCountResponse extends ApiResponse {
    valueConceptCount: ValueConceptCountType;
}
declare interface ListValueConceptsResponse extends ApiResponse {
    listValueConcepts: ListValueConceptsType;
}
declare interface FieldConceptResponse extends ApiResponse {
    fieldConcept: FieldConceptType;
}
declare interface GetIndexingStatusResponse extends ApiResponse {
    getIndexingStatus: IndexingStatusType;
}
declare interface UngroupedDatabasesResponse extends ApiResponse {
    ungroupedDatabases: DatabaseIdListType;
}
declare interface ColumnsResponse extends PaginatedApiResponse {
    columns: ColumnListType;
}
declare interface DatabasesResponse extends PaginatedApiResponse {
    databases: DatabaseListType;
}
declare interface DatasourcesResponse extends PaginatedApiResponse {
    datasources: DataSourceListType;
}
declare interface ExtractsResponse extends PaginatedApiResponse {
    extracts: ExtractListType;
}
declare interface FlowsResponse extends PaginatedApiResponse {
    flows: FlowListType;
}
declare interface FlowOutputStepsResponse extends PaginatedApiResponse {
    flowOutputSteps: FlowOutputStepListType;
}
declare interface GroupsResponse extends PaginatedApiResponse {
    groups: GroupListType;
}
declare interface MetricsResponse extends PaginatedApiResponse {
    metrics: MetricListType;
}
declare interface ProjectsResponse extends PaginatedApiResponse {
    projects: ProjectListType;
}
declare interface RevisionsResponse extends PaginatedApiResponse {
    revisions: RevisionListType;
}
declare interface SchedulesResponse extends PaginatedApiResponse {
    schedules: ScheduleListType;
}
declare interface SitesResponse extends PaginatedApiResponse {
    sites: SiteListType;
}
declare interface TablesResponse extends PaginatedApiResponse {
    tables: TableListType;
}
declare interface UsersResponse extends PaginatedApiResponse {
    users: UserListType;
}
declare interface WorkbooksResponse extends PaginatedApiResponse {
    workbooks: WorkbookListType;
}
declare interface SubscriptionsResponse extends PaginatedApiResponse {
...
declare type StateType = "Active" | "Suspended";
/**
