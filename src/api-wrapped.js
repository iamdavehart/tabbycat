...
export class WrappedApiCalls {
    ...
    deleteFlowPermission(flowId, groupId, userId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteFlowPermission(
            siteId,
            flowId,
            groupId,
            userId,
    ...
    deleteFlowPermissionsForGroup(flowId, groupId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteFlowPermissionsForGroup(
            siteId,
            flowId,
            groupId,
            capabilityName,
    ...
    deleteFlowPermissionsForUser(flowId, userId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteFlowPermissionsForUser(
            siteId,
            flowId,
            userId,
            capabilityName,
    ...
    downloadDataSourceRevision(datasourceId, revisionNumber, queryOptions, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.downloadDataSourceRevision(
            siteId,
            datasourceId,
            revisionNumber,
            queryOptions,
    ...
    deleteDatabasePermissions(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDatabasePermissions(
            siteId,
            databaseId,
            userId,
            groupId,
    ...
    deleteDatabasePermissionsForGroup(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDatabasePermissionsForGroup(
            siteId,
            databaseId,
            userId,
            capabilityName,
    ...
    deleteDatabasePermissionsForUser(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDatabasePermissionsForUser(
            siteId,
            databaseId,
            groupId,
            capabilityName,
    ...
    deleteDefaultDatabasePermissions(databaseId, userId, capabilityMode, groupId, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDefaultDatabasePermissions(
            siteId,
            databaseId,
            userId,
            capabilityMode,
    ...
    deleteDefaultDatabasePermissionsForUser(databaseId, userId, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDefaultDatabasePermissionsForUser(
            siteId,
            databaseId,
            userId,
            capabilityMode,
    ...
    deleteDefaultDatabasePermissionsForGroup(databaseId, capabilityMode, groupId, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDefaultDatabasePermissionsForGroup(
            siteId,
            databaseId,
            capabilityMode,
            groupId,
    ...
    addDataQualityWarning(contentType, contentLuid, dataQualityWarning, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.addDataQualityWarning(
            siteId,
            contentType,
            contentLuid,
            dataQualityWarning,
    ...
    deleteDataSourcePermission(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDataSourcePermission(
            siteId,
            datasourceId,
            groupId,
            userId,
    ...
    deleteDataSourcePermissionForGroup(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDataSourcePermissionForGroup(
            siteId,
            datasourceId,
            groupId,
            capabilityName,
    ...
    deleteDataSorucePermissionForUser(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDataSorucePermissionForUser(
            siteId,
            datasourceId,
            userId,
            capabilityName,
    ...
    deleteProjectPermission(projectId, groupId, userId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteProjectPermission(
            siteId,
            projectId,
            groupId,
            userId,
    ...
    deleteProjectPermissionForGroup(projectId, groupId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteProjectPermissionForGroup(
            siteId,
            projectId,
            groupId,
            capabilityName,
    ...
    deleteProjectPermissionForUser(projectId, userId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteProjectPermissionForUser(
            siteId,
            projectId,
            userId,
            capabilityName,
    ...
    deleteDefaultPermission(projectId, groupId, userId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDefaultPermission(
            siteId,
            projectId,
            groupId,
            userId,
    ...
    deleteDefaultWorkbookPermissionForGroup(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDefaultWorkbookPermissionForGroup(
            siteId,
            projectId,
            groupId,
            capabilityName,
    ...
    deleteDefaultWorkbookPermissionForUser(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDefaultWorkbookPermissionForUser(
            siteId,
            projectId,
            userId,
            capabilityName,
    ...
    deleteDefaultDatasourcePermissionsForGroup(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDefaultDatasourcePermissionsForGroup(
            siteId,
            projectId,
            groupId,
            capabilityName,
    ...
    deleteDefaultFlowPermissionForGroup(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDefaultFlowPermissionForGroup(
            siteId,
            projectId,
            groupId,
            capabilityName,
    ...
    deleteDefaultFlowPermissionForUser(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteDefaultFlowPermissionForUser(
            siteId,
            projectId,
            userId,
            capabilityName,
    ...
    deleteViewPermission(viewId, groupId, userId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteViewPermission(
            siteId,
            viewId,
            groupId,
            userId,
    ...
    deleteViewPermissionForGroup(viewId, groupId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteViewPermissionForGroup(
            siteId,
            viewId,
            groupId,
            capabilityName,
    ...
    deleteViewPermissionForUser(viewId, userId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteViewPermissionForUser(
            siteId,
            viewId,
            userId,
            capabilityName,
    ...
    deleteWorkbookPermission(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteWorkbookPermission(
            siteId,
            workbookId,
            groupId,
            userId,
    ...
    deleteWorkbookPermissionForGroup(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteWorkbookPermissionForGroup(
            siteId,
            workbookId,
            groupId,
            capabilityName,
    ...
    deleteWorkbookPermissionForUser(workbookId, userId, capabilityName, capabilityMode, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteWorkbookPermissionForUser(
            siteId,
            workbookId,
            userId,
            capabilityName,
    ...
    createExtractsForEmbeddedDataSourcesInAWorkbook(
        ...
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.createExtractsForEmbeddedDataSourcesInAWorkbook(
            siteId,
            workbookId,
            datasources,
            queryOptions,
    ...
    deleteExtractsForEmbeddedDataSourcesInAWorkbook(workbookId, datasources, callback) {
        const siteId = this.getSite();
        const opts = this.execOpts({ callback: callback });
        return api.deleteExtractsForEmbeddedDataSourcesInAWorkbook(
            siteId,
            workbookId,
            datasources,
            opts
