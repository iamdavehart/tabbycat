...
export type ContentLocationRequestType =
    | ({ location?: LocationType } | { noLocation?: NoLocationType })
    | { [k: string]: unknown };
...
export type ExtractRefreshJobType = { view: ViewType } | { workbook: WorkbookType } | { datasource: DataSourceType };

// type: type
// name: ExtractType
export type ExtractType = { datasource: DataSourceType } | { workbook: WorkbookType };
...
export type GranteeCapabilitiesType = { group: GroupType } | { user: UserType };
...
export type NameCharacteristicsType = { textPattern?: TextPatternType } | { [k: string]: unknown };
...
export type SemanticsValueType =
    | ({ numberValue?: number } | { stringValue?: string } | { timeValue?: string } | { boolValue?: boolean | number })
    | { [k: string]: unknown };
...
export type TaskExtractRefreshType = { view: ViewType } | { workbook: WorkbookType } | { datasource: DataSourceType };
...
export type ValueCharacteristicsType = { textPattern?: TextPatternType } | { [k: string]: unknown };

// type: type
// name: ValueSourceType
export type ValueSourceType = { datasourceValueStore?: DataSourceValueStoreType } | { [k: string]: unknown };
